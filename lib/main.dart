...
import 'package:mage/controller/pokeController.dart';
import 'package:mage/model/poke_model.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        MyRoutes.uploadRoute: (context) => image(
              title: 'imageupload',
            ),
        MyRoutes.loginRoute: (context) => Loginpage(),
        MyRoutes.apiRoute: (context) => HomePage(),
